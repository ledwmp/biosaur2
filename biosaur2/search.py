...
def run():
    ...
    parser.add_argument('-scan_range', help='Lower/Upper bound on MS1 Scans to keep in analysis. Comma-delimited list of ranges. ex: "400.0-500.0,500.0-600.0"', default='', type=str)
